...
<script>
    import SideMenu from '../components/enrollment/SideMenu.vue';
    import Header from '../components/enrollment/Header.vue';
    import Footer from '../components/enrollment/Footer.vue';
