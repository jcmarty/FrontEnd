    ...
    export default {
        ...
        methods: {
          setFormValues: function(){
            ...
            this.params.context.componentParent.curriculum.course_id = this.params.data.course_id;
            this.params.context.componentParent.curriculum.strand_id = this.params.data.strand_id;
          }
        }
    };
</script>
